...
$defaultoptions = array(
    ...
    'farbvarianten' => ' ',
    'src_basemod_gelb' => get_template_directory_uri() . '/css/basemod_gelb.css',
    'src_basemod_orange' => get_template_directory_uri() . '/css/basemod_orange.css',
    'src_basemod_rot' => get_template_directory_uri() . '/css/basemod_rot.css',
    'src_basemod_gruen' => get_template_directory_uri() . '/css/basemod_gruen.css',
    'src_basemod_hellblau' => get_template_directory_uri() . '/css/basemod_hellblau.css',
    'src_basemod_studium-berufspadagogik-technik' => get_template_directory_uri() . '/css/basemod_studium-berufspadagogik-technik.css',
    'src_basemod_studium-cbi' => get_template_directory_uri() . '/css/basemod_studium-cbi.css',
    'src_basemod_studium-ce' => get_template_directory_uri() . '/css/basemod_studium-ce.css',
    'src_basemod_studium-cen' => get_template_directory_uri() . '/css/basemod_studium-cen.css',
    'src_basemod_studium-cme' => get_template_directory_uri() . '/css/basemod_studium-cme.css',
    'src_basemod_studium-eei' => get_template_directory_uri() . '/css/basemod_studium-eei.css',
    'src_basemod_studium-et' => get_template_directory_uri() . '/css/basemod_studium-et.css',
    'src_basemod_studium-informatik' => get_template_directory_uri() . '/css/basemod_studium-informatik.css',
    'src_basemod_studium-ip' => get_template_directory_uri() . '/css/basemod_studium-ip.css',
    'src_basemod_studium-ipm' => get_template_directory_uri() . '/css/basemod_studium-ipm.css',
    'src_basemod_studium-iuk' => get_template_directory_uri() . '/css/basemod_studium-iuk.css',
    'src_basemod_studium-lehramt-informatik' => get_template_directory_uri() . '/css/basemod_studium-lehramt-informatik.css',
    'src_basemod_studium-lse' => get_template_directory_uri() . '/css/basemod_studium-lse.css',
    'src_basemod_studium-mb' => get_template_directory_uri() . '/css/basemod_studium-mb.css',
    'src_basemod_studium-mechatronik' => get_template_directory_uri() . '/css/basemod_studium-mechatronik.css',
    'src_basemod_studium-medizintechnik' => get_template_directory_uri() . '/css/basemod_studium-medizintechnik.css',
    'src_basemod_studium-nano' => get_template_directory_uri() . '/css/basemod_studium-nano.css',
    'src_basemod_studium-win' => get_template_directory_uri() . '/css/basemod_studium-win.css',
    'src_basemod_studium-wing' => get_template_directory_uri() . '/css/basemod_studium-wing.css',
    'src_basemod_studium-ww' => get_template_directory_uri() . '/css/basemod_studium-ww.css',
